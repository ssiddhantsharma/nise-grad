...
RUN=~/siddhant/chemistry_fap/runs/apix_rfd3
J=~/siddhant/oss/nise-grad/scripts/data/rfd3_arm_designs.json
...
cd ~/siddhant/oss/nise-grad
export PROTENIX_DIR=~/siddhant/tools/Protenix
OUT=~/siddhant/oss/nise-grad/scripts/data/rfd3_arm; mkdir -p "$OUT"
